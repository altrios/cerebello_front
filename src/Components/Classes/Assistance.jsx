    ...
    const studentsAsistance = () => {
        ...
        axios(config)
            .then(function (response) {
                ...
                document.getElementById("attended").innerHTML='<h3><bold>Asistencia de la fecha '+selectedDate+'</bold></h3>'
...
console.log(data.attributes.student_id)
                        var axios = require('axios');
                        ...
                        axios(config)
                            .then(function (response) {
                                ...
                                setSutents(response.data.data.attributes);
                                document.getElementById("attended").innerHTML+='<br><span>'+response.data.data.attributes.user_name+'</span>'
                ...
                <div className={classes.content}>
                    <List componet='nav'>
                        ...
                        <ListItem >
                            ...
                            <div><span id="attended">aja</span></div>
